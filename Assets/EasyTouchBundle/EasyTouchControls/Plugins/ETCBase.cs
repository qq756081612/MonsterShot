...
public abstract class ETCBase : MonoBehaviour {
	...
	protected void CameraFollow(){
        ...
        cameraTransform.position = new Vector3(0, cameraLookAt.position.y + localOffset.y, cameraLookAt.position.z + localOffset.z);
        cameraTransform.LookAt(new Vector3(0, cameraLookAt.position.y, cameraLookAt.position.z));
        //}
        //else{
